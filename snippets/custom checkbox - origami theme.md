...
cover: "[[img-custom checkbox - origami theme.webp]]"
obsidian-version: 1.12.7
installer-version: 1.12.7
---
# Custom checkbox - origami theme

![](../attachments/img-custom%20checkbox%20-%20origami%20theme.webp)
...
li.is-checked:where(li[data-task="-"],
  li[data-task=">"],
  li[data-task="B"],
  li[data-task="X"],
  li[data-task="b"],
...
.markdown-source-view input[type="checkbox"]:where(li[data-task="-"],
  li[data-task=">"],
  li[data-task="B"],
  li[data-task="X"],
  li[data-task="b"],
...
li.is-checked:where(li[data-task="-"],
  ...
  li[data-task="?"],
  li[data-task="i"],
  li[data-task="/"]) input[type="checkbox"]::after,
.markdown-source-view input[type="checkbox"]:where(li[data-task="-"],
  li[data-task=">"],
  li[data-task="B"],
  li[data-task="X"],
