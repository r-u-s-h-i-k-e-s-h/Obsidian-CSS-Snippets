...
cover: "[[img-workspace - square ui.webp]]"
obsidian-version: 1.12.7
installer-version: 1.12.7
---
# Workspace - square ui

![](../attachments/img-workspace%20-%20square%20ui.webp)
...
.workspace .mod-root .workspace-tab-header-container .workspace-tab-header-container-inner .workspace-tab-header:hover .workspace-tab-header-inner:not(:has(.mod-pinned)),
.workspace .mod-root .workspace-tab-header-container .workspace-tab-header-container-inner .workspace-tab-header.is-active .workspace-tab-header-inner:not(:has(.mod-pinned)) {
  padding-right: 0px;
}

.workspace .mod-root .workspace-tab-header-container .workspace-tab-header-container-inner .workspace-tab-header:hover .workspace-tab-header-inner .workspace-tab-header-inner-close-button,
.workspace .mod-root .workspace-tab-header-container .workspace-tab-header-container-inner .workspace-tab-header.is-active .workspace-tab-header-inner .workspace-tab-header-inner-close-button {
  display: flex;
  position: static;
}
