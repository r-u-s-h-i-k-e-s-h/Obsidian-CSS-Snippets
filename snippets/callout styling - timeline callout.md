...
cover: "[[img-callout styling - timeline callout.webp]]"
obsidian-version: 1.12.7
installer-version: 1.12.7
---
# Callout styling - timeline callout

> - May conflict with **SlRvb's Callout Adjustment** or the **ITS Theme**
> - Best viewed in **Reading Mode**

![](../attachments/img-callout%20styling%20-%20timeline%20callout.webp)
...
```md
> [!timeline|red] July 14, 1789
> State prison stormed by an armed mob during the French Revolution. This event symbolized the collapse of royal authority and catalyzed the absolute monarchy's downfall.

> [!timeline|cyan] June 28, 1914
> Archduke Franz Ferdinand of Austria assassinated in Sarajevo by Gavrilo Princip. This critical event triggered a diplomatic crisis that rapidly escalated into World War I.

> [!timeline|green] July 20, 1969
> Apollo 11 lunar module lands safely on the moon's surface. Astronaut Neil Armstrong becomes the first human to walk on another celestial body.
```