...
cover: "[[img-sidebar - custom tab icon.webp]]"
obsidian-version: 1.12.7
installer-version: 1.12.7
---
# Sidebar - custom tab icon

![](../attachments/img-sidebar%20-%20custom%20tab%20icon.webp)
...
note: To target a different note/tab, change the [aria-label="Inbox"] value to match the exact title of your note (e.g., [aria-label="Daily Note"])
*/
