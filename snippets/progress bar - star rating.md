...
cover: "[[img-progress bar - star rating.webp]]"
obsidian-version: 1.12.7
installer-version: 1.12.7
---
# Progress bar - star rating

![](../attachments/img-progress%20bar%20-%20star%20rating.webp)
...
```md
<progress class="star" id="file" max="100" value="25"></progress>
<progress class="star" id="file" max="100" value="44"></progress>
<progress class="star" id="file" max="100" value="66"></progress>
<progress class="star" id="file" max="100" value="87"></progress>
<progress class="star" id="file" max="100" value="97"></progress>
```
